...
document.addEventListener('DOMContentLoaded', () => {
    // Socket.io connection - Connect to the same server that's serving the HTML
    const socket = io();
    
    // Rest of your online.js code remains the same...
    ...
    if (joinRoomBtn) {
        joinRoomBtn.addEventListener('click', () => {
            ...
            if (roomCode.length === 4) {
                ...
                alert('Please enter a valid room ID (4 characters)');
            }
        });
    }
